...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    DWORD window_flags = ImGuiWindowFlags_NoMove | io.ConfigWindowsMoveFromTitleBarOnly | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoNav |ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoBringToFrontOnFocus;
    ...
    iWidth = rDesktop.right;
    iHeight = rDesktop.bottom;
    GetWindowRect(GetDesktopWindow(), &screen_rect);
    auto x = float(screen_rect.right - iWidth) / 2.f;
    auto y = float(screen_rect.bottom - iHeight) / 2.f;
